...
\texttt{netvis} has been implemented as a \texttt{pip} package, and can be
installed by typing the following in a terminal window.

\begin{lstlisting}
pip install -e "git+https://github.com/goats-9/cs3530-assignments.git#egg=netvis&subdirectory=netvis"
\end{lstlisting}

The dependencies of the \texttt{netvis} package are:
